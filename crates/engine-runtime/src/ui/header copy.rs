...
// Unicode icons – more readable and flexible than hard‑coded numbers.
pub const ICON_SETTINGS: &str = "\u{2699}";   // ⚙
pub const ICON_MINIMIZE: &str = "\u{2014}";   // ─
pub const ICON_MAXIMIZE: &str = "\u{1F5D6}";  // 🗖
pub const ICON_RESTORE: &str = "\u{1F5D7}";   // 🗗
